...
import ShopCenter from './HJShopCenter';
import ShopCenterDetail from './HJShopCenterDetail';
import GeustYouLike from './HJGeustYouLike';

const {width, height} = Dimensions.get('window');

class HJHome extends Component {
  render() {
    return (
